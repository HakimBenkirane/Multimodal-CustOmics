...
from src.tools.utils import load_graph
import numpy as np
...
class MultiModalDataset(Dataset):
    ...
    def __init__(self, omics_df, clinical_df, lt_samples, label,
                     event, surv_time, graph_path=None):
    ...
    def __getitem__(self, index):
        ...
        graph = load_graph(self.graph_path, self.clinical_df.loc[sample, 'slide_id'])
        omics_data = []
        ...
        return graph, omics_data, label, os_time, os_event
