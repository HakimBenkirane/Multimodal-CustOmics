...
parser.add_argument('-dr', '--data_directory', help='folder in which the data are stored', type=str, default='../data/TCGA/')
...
parser.add_argument('-b', '--batch_size', help='batch size for the data loader', type=int, default=33)
